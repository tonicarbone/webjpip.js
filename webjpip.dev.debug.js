...
// Demo attempt
module.exports.demo = __webpack_require__(48);
...
function buildHTMLTileStructure() {
	...
	for (var y = 0; y < numTilesY; ++y) {
		...
		for (var x = 0; x < numTilesX; ++x) {
			var name = x + '_' + y;
			var params = '' + x + ', ' + y;
			tableHTML += '<td>' + '<span id="span' + name + '"></span><br>' + '<a id="linkLoadTile' + name + '" href="javascript:loadTile(' + params + ')" >Load tile</a><br>' + '<div><canvas id="canvas' + name + '"></canvas></div><br>' + '<a id="linkShowCodestream' + name + '" href="javascript:showCodestream(' + params + ')" ></a>' + '</td>';
		}
...
function loadTile(tileX, tileY) {
	...
	function tryDecodePendingCodestream() {
		...
		isPendingCodestreamEndOfProgressiveRendering = pendingCodestreamToDecode.isPendingCodestreamEndOfProgressiveRendering;
	...
	var requestContext = image.createDataRequest(codestreamPartParams, dataCallback,
